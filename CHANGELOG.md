...
### Added
- 16 specialized AI sub-agents for product management workflows
- Tree of Thought analysis patterns (business-consultant, market-strategy)
- Interview coaching and summary agents
- Pricing strategist with Monetizing Innovation framework
- VC review with BMAD adversarial stress-testing
...
- CEO review agent
- Business model architect (Canvas + Ten Types + 50 patterns)
