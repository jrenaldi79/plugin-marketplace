...
| Expert Debate Facilitator | `/debate` | User-scoped expert panels (business/venture, technical, specialty technical, financial, customer/market, or mixed) with parallel panel support and cross-panel synthesis | `outputs/debate-*.md` |
